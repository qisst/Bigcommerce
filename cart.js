...
$.ajax(settings).done(function (response) {
  ...
  for (const ele of document.querySelectorAll(".btn--add-to-cart,button.product__add-to-cart-button")){
    ...
    jQuery(".page-content .cart-actions").after('<button type="button" href="javascript:void(0);" id="1c_product_button"  class="oneclick-button button button--primary one-click-button" onclick="triggerIFrame()">1-Click Checkout-Cart</button>');
